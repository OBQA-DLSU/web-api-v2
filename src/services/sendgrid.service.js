...
const sg = require('sendgrid')(Config.SG.API_KEY);
const sgMailHelper = require('sendgrid').mail;

const basicMail = (sender = 'GCOE.noreply', receiver, subject, message) => {
  return new Promise(async(resolve, reject) => {
    ...
    try {
      sgMail.setApiKey(Config.SG.API_KEY);
...
const mailWithCC = (sender = 'GCOE.noreply', receiver, subject, message, cc = [], senderName = null) => {
  return new Promise(async(resolve, reject) => {
